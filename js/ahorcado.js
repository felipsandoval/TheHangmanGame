...
function doTry() {
    if (inicializado) {
        ...
        if (aciertos === random_word.length) {
            ...
            imagen.src = "img/ahorcado_2.png";
            console.log("Tendremos piedad de ti y cuándo te reste una oportunidad te diré la respuesta.");
        } else if (errores === 2) {
            imagen.src = "img/ahorcado_3.png";
        } else if (errores === 3) {
            imagen.src = "img/ahorcado_4.png";
        } else if (errores === 4) {
            imagen.src = "img/ahorcado_5.png";
        } else if (errores === 5) {
            imagen.src = "img/ahorcado_6.png";
        } else if (errores === 6) {
            imagen.src = "img/ahorcado_7.png";
            console.log("La palabra que buscas es: [" + random_word + "]");
        } else if (errores === 7) {
            imagen.src = "img/ahorcado_8.png";
